...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Temp\Codigos Python\PY Jogos\Jogo da Memoria'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Temp\Codigos Python\PY Jogos\Jogo da Memoria\Scripts\deactivate.nu'
